...
To import maps and trainer data from the [Pokecrossroads](https://github.com/eonlynx/pokecrossroads) project, run the helper script from the repository root:
