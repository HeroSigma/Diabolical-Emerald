...
#define SHOULD_SWITCH_BADLY_POISONED_STATS_RAISED_PERCENTAGE    66
#define SHOULD_SWITCH_CURSED_PERCENTAGE                         100
#define SHOULD_SWITCH_CURSED_STATS_RAISED_PERCENTAGE            66
#define SHOULD_SWITCH_NIGHTMARE_PERCENTAGE                      66
#define SHOULD_SWITCH_NIGHTMARE_STATS_RAISED_PERCENTAGE         33
#define SHOULD_SWITCH_SEEDED_PERCENTAGE                         66
#define SHOULD_SWITCH_SEEDED_STATS_RAISED_PERCENTAGE            33
...
#define SHOULD_RECOVER_CHANCE                                   100 // Chance the AI will give recovery moves score increase if less than ENABLE_RECOVERY_THRESHOLD and in no immediate danger
#define ENABLE_RECOVERY_THRESHOLD                               70 // HP percentage beneath which SHOULD_RECOVER_CHANCE is active
#define SUCKER_PUNCH_CHANCE                                     90 // Chance for the AI to not use Sucker Punch if the player has a status move
#define SUCKER_PUNCH_PREDICTION_CHANCE                          90 // Additional chance for the AI to not use Sucker Punch if actively predicting a status move if SUCKER_PUNCH_CHANCE fails
...
#define AI_TERA_PREDICT_CHANCE                                  100 // Chance for AI with smart tera flag to tera in the situation where tera would save it from a KO, but could be punished by a KO from a different move. 

// AI_FLAG_PP_STALL_PREVENTION settings
#define PP_STALL_DISREGARD_MOVE_PERCENTAGE                      90 // Detection chance per roll
#define PP_STALL_SCORE_REDUCTION                                40 // Score reduction if any roll for PP stall detection passes
...
#define ASSUME_ALL_STATUS_ODDS                          50 // Chance for the AI to see any kind of status move.
...
#define DOUBLE_TRICK_ROOM_ON_LAST_TURN_CHANCE    75 // both pokemon use Trick Room on turn Trick Room expires in the hopes both opponents used Protect to stall, getting a free refresh on the timer
#define TAILWIND_IN_TRICK_ROOM_CHANCE            75 // use Tailwind on turn Trick Room expires in the hopes both opponents used Protect to stall
