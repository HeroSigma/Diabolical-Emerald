...
#define TIME_MORNING     TIMEOFDAY_MORNING
#define TIME_DAY         TIMEOFDAY_DAY
#define TIME_EVENING     TIMEOFDAY_EVENING
#define TIME_NIGHT       TIMEOFDAY_NIGHT
#define TIMES_OF_DAY_COUNT TIMEOFDAY_COUNT
