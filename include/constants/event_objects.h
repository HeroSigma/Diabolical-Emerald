...
// Aliases for cross-region rival sprites. These are mapped to the
// existing Hoenn rival graphics until dedicated graphics are added.
#define OBJ_EVENT_GFX_RIVAL_RED_NORMAL    OBJ_EVENT_GFX_RIVAL_BRENDAN_NORMAL
#define OBJ_EVENT_GFX_RIVAL_LEAF_NORMAL   OBJ_EVENT_GFX_RIVAL_MAY_NORMAL
#define OBJ_EVENT_GFX_RIVAL_GOLD_NORMAL   OBJ_EVENT_GFX_RIVAL_BRENDAN_NORMAL
#define OBJ_EVENT_GFX_RIVAL_LYRA_NORMAL   OBJ_EVENT_GFX_RIVAL_MAY_NORMAL
