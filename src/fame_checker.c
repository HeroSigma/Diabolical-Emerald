...
static const u8 sFameCheckerTrainerPicIdxs[] = {
    [FAMECHECKER_OAK]      = TRAINER_PIC_KANTO_CAMPER,
    [FAMECHECKER_DAISY]    = TRAINER_PIC_KANTO_LASS,
    ...
    [FAMECHECKER_MRFUJI]   = TRAINER_PIC_KANTO_GENTLEMAN,
...
static const u8 sFameCheckerArrayNpcGraphicsIds[] = {
    ...
    OBJ_EVENT_GFX_CLIPBOARD,
    OBJ_EVENT_GFX_KANTO_OLD_WOMAN,
    OBJ_EVENT_GFX_CLIPBOARD,
    // BROCK
    OBJ_EVENT_GFX_GYM_SIGN,
    OBJ_EVENT_GFX_BROCK,
    OBJ_EVENT_GFX_KANTO_FAT_MAN,
    OBJ_EVENT_GFX_BOY,
    ...
    OBJ_EVENT_GFX_CLIPBOARD,
    OBJ_EVENT_GFX_KANTO_LITTLE_GIRL,
    OBJ_EVENT_GFX_KANTO_OLD_WOMAN,
    // BRUNO
    OBJ_EVENT_GFX_BRUNO,
    OBJ_EVENT_GFX_BRUNO,
