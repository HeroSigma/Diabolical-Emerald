...
const u16 gTrainerPalette_Dawn[] = INCBIN_U16("graphics/trainers/palettes/dawn.pal");
const u32 gTrainerFrontPic_Lucas[] = INCBIN_U32("graphics/trainers/front_pics/DP_Lucas.4bpp.smol");
const u16 gTrainerPalette_Lucas[] = INCBIN_U16("graphics/trainers/palettes/lucas.pal");
const u32 gTrainerFrontPic_Gold[] = INCBIN_U32("graphics/trainers/front_pics/gold.4bpp.smol");
const u16 gTrainerPalette_Gold[] = INCBIN_U16("graphics/trainers/palettes/gold.pal");
...
const struct TrainerSprite gTrainerSprites[] =
{
    ...
    TRAINER_SPRITE(TRAINER_PIC_DP_DAWN, gTrainerFrontPic_Dawn, gTrainerPalette_Dawn),
...
const struct TrainerBacksprite gTrainerBacksprites[] =
{
    ...
    TRAINER_BACK_SPRITE(TRAINER_BACK_PIC_GOLD, 4, gTrainerBackPic_Gold, gTrainerPalette_Gold, sBackAnims_Hoenn),
    TRAINER_BACK_SPRITE(TRAINER_BACK_PIC_LYRA, 4, gTrainerBackPic_Lyra, gTrainerPalette_Lyra, sBackAnims_Hoenn),
};
