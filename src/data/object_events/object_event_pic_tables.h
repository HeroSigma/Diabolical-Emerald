...
static const struct SpriteFrameImage sPicTable_Wormhole[] = {
    overworld_frame(gObjectEventPic_Wormhole, 8, 8, 0),
    overworld_frame(gObjectEventPic_Wormhole, 8, 8, 1),
    overworld_frame(gObjectEventPic_Wormhole, 8, 8, 2),
    overworld_frame(gObjectEventPic_Wormhole, 8, 8, 3),
    overworld_frame(gObjectEventPic_Wormhole, 8, 8, 4),
};

static const struct SpriteFrameImage sPicTable_Hooparing[] = {
    overworld_frame(gObjectEventPic_Hooparing, 8, 8, 0),
    overworld_frame(gObjectEventPic_Hooparing, 8, 8, 1),
    overworld_frame(gObjectEventPic_Hooparing, 8, 8, 2),
    overworld_frame(gObjectEventPic_Hooparing, 8, 8, 3),
    overworld_frame(gObjectEventPic_Hooparing, 8, 8, 4),
};
