...
//Kanto map groups
#define MAP_GROUP_KANTO_TOWNS_AND_ROUTES MAP_GROUP(MAP_PALLET_TOWN)
#define MAP_GROUP_KANTO_DUNGEONS MAP_GROUP(MAP_VIRIDIAN_FOREST)
//Johto map groups
#define MAP_GROUP_JOHTO_TOWNS_AND_ROUTES MAP_GROUP(MAP_NEW_BARK_TOWN)
#define MAP_GROUP_JOHTO_DUNGEONS MAP_GROUP(MAP_UNION_CAVE_1F)
//Sevii map groups
#define MAP_GROUP_SEVII_TOWNS_AND_ROUTES MAP_GROUP(MAP_ONE_ISLAND)
#define MAP_GROUP_SEVII_DUNGEONS MAP_GROUP(MAP_ONE_ISLAND_KINDLE_ROAD_EMBER_SPA)
...
void DisplayPokedexAreaScreen(u16 species, u8 *screenSwitchState, u8 regionMapId, enum TimeOfDay timeOfDay, enum PokedexAreaScreenState areaState)
{
    u8 taskId;

    mapNumber = regionMapId;
