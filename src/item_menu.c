...
#define MAX_POCKET_ITEMS  (max(BAG_TMHM_COUNT,                              \
                            ...
                            max(BAG_EVOLUTION_COUNT,                    \
                            max(BAG_HELD_ITEMS_COUNT,                   \
                            max(BAG_INGREDIENTS_COUNT,                  \
                                BAG_MISC_COUNT)))))))))))) + 1)
...
struct TempWallyBag {
    struct ItemSlot bagPocket_Misc[BAG_MISC_COUNT];
...
static void PrepareBagForWallyTutorial(void)
{
    ...
    memcpy(sTempWallyBag->bagPocket_Misc, gSaveBlock1Ptr->bag.misc, sizeof(gSaveBlock1Ptr->bag.misc));
    ...
    memset(gSaveBlock1Ptr->bag.misc, 0, sizeof(gSaveBlock1Ptr->bag.misc));
...
static void RestoreBagAfterWallyTutorial(void)
{
    ...
    memcpy(gSaveBlock1Ptr->bag.misc, sTempWallyBag->bagPocket_Misc, sizeof(sTempWallyBag->bagPocket_Misc));
