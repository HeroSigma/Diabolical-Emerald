...
bool8 LoadRegionMapGfx(void)
{
    ...
    case 0:
        if (sRegionMap->bgManaged) {
            ...
            //Johto
            if(mapNumber == 1)
                LZ77UnCompVram(sRegionMapBg_GfxLZ_Johto, (u16 *)BG_CHAR_ADDR(2));
            //Hoenn
            if(mapNumber == 2)
    ...
    case 1:
        ...
        else
        {
            ...
            //Johto
            if(mapNumber == 1)
                LZ77UnCompVram(sRegionMapBg_TilemapLZ_Johto, (u16 *)BG_SCREEN_ADDR(28));
            //Hoenn
            if(mapNumber == 2)
...
static void CreateFlyDestIcons(void)
{
    ...
    //Johto
    if (mapNumber == 1) {
        canFlyFlag = FLAG_WORLD_MAP_INDIGO_PLATEAU_EXTERIOR;
        //Add Indigo Plateau
    ...
    //Sevii
    if (mapNumber == 3) {
        canFlyFlag = FLAG_WORLD_MAP_ONE_ISLAND;
