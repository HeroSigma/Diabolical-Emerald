...
// Include a dummy entry for MAPSEC_NONE so that indexes align with
// region map section IDs after removing the Kanto map sections.
static const u8 sMapSectionToThemeId[MAPSEC_COUNT - KANTO_MAPSEC_COUNT] =
{
    ...
    [MAPSEC_DYNAMIC - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_MARBLE,
